      ...
      <View style={[{
        ...
        <View style={{
          ...
          <View style={[styles.barView, this.props.barView]}>
            { this.props.showArrows && this.state.stage === DAY_SELECTOR && previousMonthValid ?
              ...
              >
                <Text style={this.props.arrowText}>{LEFT_CHEVRON}</Text>
            ...
            { this.props.showArrows && this.state.stage === DAY_SELECTOR && nextMonthValid ?
              ...
              >
                <Text style={this.props.arrowText}>{RIGHT_CHEVRON}</Text>
              </TouchableHighlight> : <View/>
            }
          </View>
        </View>
        ...
        <View style={{ flex: 1, flexDirection: 'row'}}>
          ...
          <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-around' }}>
            <TouchableHighlight underlayColor={'transparent'} activeOpacity={0} style={{ justifyContent: 'center', alignItems: 'flex-end', backgroundColor: 'transparent' }} onPress={this.props.cancel}>
                  <Text style={{ color: '#A8A8A8', fontFamily: 'Hind-SemiBold', fontSize: 14}}>CANCEL</Text>
            </TouchableHighlight>
            <TouchableHighlight underlayColor={'transparent'} activeOpacity={0} style={{ justifyContent: 'center', alignItems: 'flex-end', backgroundColor: 'transparent' }} onPress={this.props.select}>
                  <Text style={{ color: '#477DEA', fontFamily: 'Hind-SemiBold', fontSize: 14}}>SELECT</Text>
            </TouchableHighlight>
          </View>
        </View>
      </View>
